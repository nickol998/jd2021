...
[task_local]
#取关所有主播
35 23 */5 * * jd_unsubscriLive.js, tag=取关所有主播, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon============
[Script]
cron "35 23 */5 * *" script-path=jd_unsubscriLive.js,tag=取关所有主播
============Surge=============
取关所有主播 = type=cron,cronexp="35 23 */5 * *",wake-system=1,timeout=3600,script-path=jd_unsubscriLive.js
===========小火箭========
取关所有主播 = type=cron,script-path=jd_unsubscriLive.js, cronexpr="35 23 */5 * *", timeout=3600, enable=true
 */
